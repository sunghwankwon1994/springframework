	...
	<div class="d-flex flex-column ">
		...
		<div class="flex-grow-1 m-2">
			<div class="d-flex row">
				...
				<div class="col-md-8">
					<!-- #################################### -->
					<a href="javascript:requestAjax()" class="btn btn-info btn-sm">AJAX로 비동기 요청 파라미터 보내기</a>
					<button onclick="requestAjax()" class="btn btn-warning btn-sm">AJAX로 비동기 요청 파라미터 보내기</button>
					<hr/>
					<form>
							...
							<div class="input-group">
								...
								<div class="form-control d-flex">
									<div>
										<input id="param4" type="radio" name="param4" checked value="true"> <label>true</label>
									</div>
									<div class="ms-3">
