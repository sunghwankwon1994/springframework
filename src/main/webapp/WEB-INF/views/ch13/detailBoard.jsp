				...
				<div class="col-md-8">
					...
					<div class="card">
						...
						<div class="card-body">
							...
							<a href="boardList" class="btn btn-info btn-sm">목록</a> <a href="updateBoardForm?bno=${board.bno}" class="btn btn-info btn-sm">수정</a> <a href="deleteBoard?bno=${board.bno}" class="btn btn-info btn-sm">삭제</a>
						</div>
					</div>
					<!-- ########################################## -->
				</div>
